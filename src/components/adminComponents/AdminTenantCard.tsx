...
export default function AdminTenantsCard({ data, showOptionsIndex, setConfirmDeleteModal, setSelectedIndex, setShowEditBlogModal, setShowOptionsIndex }: AdminTenantCardProps) {
    return (
