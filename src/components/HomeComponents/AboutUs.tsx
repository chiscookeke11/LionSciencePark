    ...
    return (
        <section className="py-20 px-6 flex flex-col md:flex-row items-center justify-evenly gap-16 font-poppins "  >
            <div className="w-full max-w-2xl text-justify " >
                ...
                <p className=" font-medium text-xl text-black font-signika">Lion Science Park (LSP) is the first university-based science park in Africa, established at the University of Nigeria, Nsukka (UNN). We serve as a hub where academia, industry, and government converge to drive innovation, research, and entrepreneurship.
                    <br />
                    <br />
         ...
         <div className=" relative" >
            ...
            <Image src={"/homepage-images/dots.svg"} alt="image" height={500} width={500} className="w-[30%] h-[50%] object-center  absolute " />
               <div className=" h-[370px] w-[370px] lg:w-[500px] lg:h-[500px]  flex items-center justify-center relative  rounded-[45%] rounded-tr-none overflow-hidden " >
