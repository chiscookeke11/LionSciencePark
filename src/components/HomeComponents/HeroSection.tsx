...
export default function HeroSection() {
    return (
        <section className=" w-full min-h-screen flex items-center justify-between  bg-white  gap-20 py-32 overflow-hidden pl-[8%] pr-[2%] font-inter " >
            ...
            <div className='w-full  h-full max-w-2xl flex items-center justify-center  -rotate-8 relative  ' >
                <Image src={"/homepage-images/arrow-svg.svg"} alt='arrow-svg' height={100} width={100} className='absolute -top-10 -left-18 ' />
                <div className='w-full  h-[550px] border-dashed border-2 border-black rounded-md overflow-hidden z-10 ' >
