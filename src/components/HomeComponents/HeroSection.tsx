...
export default function HeroSection() {
    return (
        <section className=" w-full h-screen relative flex items-center justify-center  bg-white font-poppins bg-no-repeat bg-center bg-cover bg-fixed " style={{ backgroundImage: "url('homepage-images/image1.webp')" }} >
            ...
            <div className="w-full h-full flex items-center justify-center flex-col gap-2 absolute top-0 left-0 text-center text-white " >
                ...
                <button className="mt-8 bg-[#008CC1]  px-16 py-4 font-medium flex items-center justify-center cursor-pointer rounded-md text-white " >Learn More</button>
            </div>
